...
const WhatsAppCTA: React.FC = () => {
  return (
    <section id="contact" className="py-32 bg-[#0a0f1d] border-t border-blue-900/10">
      <div className="max-w-4xl mx-auto px-4 text-center">
        <div className="inline-block p-3 bg-blue-600/10 rounded-2xl mb-8">
           <svg className="w-8 h-8 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
             <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
           </svg>
        </div>
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 tracking-tight">Prefer WhatsApp?</h2>
